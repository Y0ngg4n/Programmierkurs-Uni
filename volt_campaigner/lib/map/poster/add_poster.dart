...
class _AddPosterState extends State<AddPoster> {
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          ...
          Padding(
            ...
            child: ElevatedButton(onPressed: _addPoster, child: Row(children: [
              Icon(Icons.save),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 0, horizontal: 16),
                child: Text(AppLocalizations.of(context)!.posterAdd, style: TextStyle(fontSize: 25),),
              )
            ],)),
          )
        ]),
  ...
  _showError() {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(AppLocalizations.of(context)!.errorAddPoster),
